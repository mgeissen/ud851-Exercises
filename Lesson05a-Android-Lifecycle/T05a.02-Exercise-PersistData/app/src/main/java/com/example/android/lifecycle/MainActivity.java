...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEX = "lyfecycle";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEX)){
                String text = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEX);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEX, text);
    }
