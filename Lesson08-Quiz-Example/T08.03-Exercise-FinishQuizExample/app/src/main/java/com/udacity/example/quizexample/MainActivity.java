...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDef = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        tvWord.setText(mData.getString(mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD)));
        tvDef.setVisibility(View.INVISIBLE);
        tvDef.setText(mData.getString(mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION)));
